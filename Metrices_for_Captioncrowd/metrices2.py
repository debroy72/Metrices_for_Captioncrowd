...
# Calculating the accuracy count for each video
identifications['Accuracy Count'] = identifications['Correct Identifications']

# Calculate the total accuracy count for each user
...
# Display the total accuracy counts for each user
print("\nTotal Accuracy Count per User:")
print(total_accuracy_per_user)

# Plotting Total Accuracy Count for Each User
plt.figure(figsize=(10, 6))
sns.barplot(x=total_accuracy_per_user.index, y=total_accuracy_per_user.values)
